...
<el-row>
  ...
  <el-col :span="23">
    <el-table :data="tableInStorageOrderData" style="width: 100%" v-show="expandType=='inStorageByOrder'" row-class-name="expandtablebody" header-row-class-name="expandtableheader">
